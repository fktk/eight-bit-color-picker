...
;(function (root, factory) {
  ...
  pickerProto.show = function() {
    var selectionUI = this.loadSelectors().selectionUI
      , leftOffset = this.el.getBoundingClientRect().left
      , topOffset = this.el.getBoundingClientRect().top

    selectionUI.style.left = leftOffset + 20 + 'px'
    selectionUI.style.top = topOffset + 20 + 'px'
